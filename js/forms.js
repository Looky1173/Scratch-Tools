$(document).ready(function () {
                                      ...
                                      if(response.status === "success"){
                                        if(response.type === "pwd-changed"){
                                          $('#change-pwd-div').fadeOut(fadeAnimationDuration, function(){
                                            ...
                                            $('<div id="success-alert-changed-pwd" style="display: none;" class="alert alert-success" role="alert"> <h4 class="alert-heading">Password changed</h4> Your password was changed successfully! You may now <a href="login" class="alert-link">login</a> with your new password.</div>').insertAfter('#title');
  ...
  $('#delete-account').click(function () {
    ...
    var confirmAccountDeletion = confirm("⚠ Are you sure you want to delete your account? \n\nThis cannot be undone, and you will lose any data associated with your account.");
